...
CREATE TABLE "CompanionService" (
    ...
    CONSTRAINT "CompanionService_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "CompanionOrder" (
    "id" TEXT NOT NULL,
    ...
    CONSTRAINT "CompanionOrder_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "Post_gameId_idx" ON "Post"("gameId");
...
-- CreateIndex
CREATE INDEX "CompanionService_userId_idx" ON "CompanionService"("userId");

-- CreateIndex
CREATE INDEX "CompanionService_gameId_idx" ON "CompanionService"("gameId");

-- CreateIndex
CREATE INDEX "CompanionOrder_serviceId_idx" ON "CompanionOrder"("serviceId");

-- CreateIndex
CREATE INDEX "CompanionOrder_clientId_idx" ON "CompanionOrder"("clientId");

-- CreateIndex
CREATE INDEX "CompanionOrder_companionId_idx" ON "CompanionOrder"("companionId");

-- CreateIndex
CREATE INDEX "CompanionOrder_status_idx" ON "CompanionOrder"("status");
